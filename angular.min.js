...
e;h.$$incOutstandingRequestCount=function(){t++};h.notifyWhenNoOutstandingRequests=function(a){q(x,function(a){a()});0===t?a():G.push(a)};var x=[],u;h.addPollFn=function(a){E(u)&&f(100,p);x.push(a);return a};var N=k.href,H=a.find("base"),z=null;h.url=function(a,c){k!==b.location&&(k=b.location);m!==b.history&&(m=b.history);if(a){if(N!=a)return N=a,d.history?c?m.replaceState(null,"",a):(m.pushState(null,"",a),H.attr("href",H.attr("href"))):(z=a,c?k.replace(a):k.href=a),h}else return z||k.href.replace(/%27/g,
...
ia=p.templateDirective,S=p.nonTlbTranscludeDirective,E=!1,D=p.hasElementTranscludeDirective,Z=d.$$element=y(c),F,B,W,Ya=e,O,M=0,oa=a.length;M<oa;M++){F=a[M];var U=F.$$start,X=F.$$end;U&&(Z=C(c,U,X));W=r;if(u>F.priority)break;if(W=F.scope)H=H||F,F.templateUrl||(I("new/isolated scope",Q,F,Z),T(W)&&(Q=F));B=F.name;!F.templateUrl&&F.controller&&(W=F.controller,K=K||{},I("'"+B+"' controller",K[B],F,Z),K[B]=F);if(W=F.transclude)E=!0,F.$$tlb||(I("transclusion",S,F,Z),S=F),"element"==W?(D=!0,u=F.priority,
...
oa=a.length}else Z.html(W);if(F.templateUrl)I("template",ia,F,Z),ia=F,F.replace&&(g=F),N=w(a.splice(M,a.length-M),Z,d,f,Ya,l,n,{controllerDirectives:K,newIsolateScopeDirective:Q,templateDirective:ia,nonTlbTranscludeDirective:S}),oa=a.length;else if(F.compile)try{O=F.compile(Z,d,Ya),P(O)?x(null,O,U,X):O&&x(O.pre,O.post,U,X)}catch(aa){m(aa,ha(Z))}F.terminal&&(N.terminal=!0,u=Math.max(u,F.priority))}N.scope=H&&!0===H.scope;N.transclude=E&&Ya;p.hasElementTranscludeDirective=D;return N}function wc(a){for(var b=
...
a);e&&(this.$$element.prop(a,b),d=e);this[a]=b;d?this.$attr[a]=d:(d=this.$attr[a])||(this.$attr[a]=d=ib(a,"-"));e=Ma(this.$$element);if("A"===e&&"href"===a||"IMG"===e&&"src"===a)this[a]=b=H(b,"src"===a);!1!==c&&(null===b||b===r?this.$$element.removeAttr(d):this.$$element.attr(d,b));(c=this.$$observers)&&q(c[a],function(a){try{a(b)}catch(c){m(c)}})},$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers={}),e=d[a]||(d[a]=[]);e.push(b);G.$evalAsync(function(){e.$$inter||b(c[a])});return function(){Fa(e,
...
b);-1!==a&&s.pendingRequests.splice(a,1)}var n=p.defer(),t=n.promise,u,q,r=G(b.url,b.params);s.pendingRequests.push(b);t.then(k,k);(b.cache||e.cache)&&(!1!==b.cache&&"GET"==b.method)&&(u=T(b.cache)?b.cache:T(e.cache)?e.cache:x);if(u)if(q=u.get(r),A(q)){if(q.then)return q.then(k,k),q;L(q)?l(q[1],q[0],ca(q[2]),q[3]):l(q,200,{},"OK")}else u.put(r,t);E(q)&&a(b.method,r,c,g,f,b.timeout,b.withCredentials,b.responseType);return t}function G(a,b){if(!b)return a;var c=[];dd(b,function(a,b){null===a||E(a)||
...
g(d)}},G=function(b){try{return(P(m)?m:d)(b)}catch(c){return a(c),g(c)}},x=function(b){try{return(P(p)?p:c)(b)}catch(d){a(d)}};b(function(){f(h).then(function(a){s||(s=!0,n.resolve(f(a).then(t,G,x)))},function(a){s||(s=!0,n.resolve(G(a)))},function(a){s||n.notify(x(a))})});return n.promise},all:function(a){var b=e(),c=0,d=L(a)?[]:{};q(a,function(a,e){c++;f(a).then(function(a){d.hasOwnProperty(e)||(d[e]=a,--c||b.resolve(d))},function(a){d.hasOwnProperty(e)||b.reject(a)})});0===c&&b.resolve(d);return b.promise}}}
...
function(b){return v(b)?b.trim():b}:function(b){return v(b)?b.replace(/^\s\s*/,"").replace(/\s\s*$/,""):b}}();Ma=9>U?function(b){b=b.nodeName?b:b[0];return b.scopeName&&"HTML"!=b.scopeName?Ga(b.scopeName+":"+b.nodeName):b.nodeName}:function(b){return b.nodeName?b.nodeName:b[0].nodeName};var ec=["ng-","data-ng-","ng:","x-ng-"],jd=/[A-Z]/g,md={full:"1.3.0-local+sha.1192531",major:1,minor:3,dot:0,codeName:"snapshot"},Wa=M.cache={},jb=M.expando="ng-"+(new Date).getTime(),Be=1,qb=O.document.addEventListener?
...
compile:function(a,c){8>=U&&(c.href||c.name||c.$set("href",""),a.append(V.createComment("IE fix")));if(!c.href&&!c.xlinkHref&&!c.name)return function(a,c){var f="[object SVGAnimatedString]"===ya.call(c.prop("href"))?"xlink:href":"href";c.on("click",function(a){c.attr(f)||a.preventDefault()})}}}),Fb={};q(nb,function(a,c){if("multiple"!=a){var d=na("ng-"+c);Fb[d]=function(){return{priority:100,link:function(a,f,g){a.$watch(g[d],function(a){g.$set(c,!!a)})}}}}});q(["src","srcset","href"],function(a){var c=
na("ng-"+a);Fb[c]=function(){return{priority:99,link:function(d,e,f){var g=a,h=a;"href"===a&&"[object SVGAnimatedString]"===ya.call(e.prop("href"))&&(h="xlinkHref",f.$attr[h]="xlink:href",g=null);f.$observe(c,function(a){a&&(f.$set(h,a),U&&g&&e.prop(g,f[h]))})}}}});var xb={$addControl:w,$removeControl:w,$setValidity:w,$setDirty:w,$setPristine:w};Xc.$inject=["$element","$attrs","$scope","$animate"];var Yc=function(a){return["$timeout",function(c){return{name:"form",restrict:a?"EAC":"E",controller:Xc,
compile:function(){return{pre:function(a,e,f,g){if(!f.action){var h=function(a){a.preventDefault?a.preventDefault():a.returnValue=!1};qb(e[0],"submit",h);e.on("$destroy",function(){c(function(){Va(e[0],"submit",h)},0,!1)})}var l=e.parent().controller("form"),k=f.name||f.ngForm;k&&sb(a,k,g,k);if(l)e.on("$destroy",function(){l.$removeControl(g);k&&sb(a,k,r,k);D(g,xb)})}}}}}]},qd=Yc(),Dd=Yc(!0),bf=/^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,cf=/^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i,
df=/^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/,Zc=/^(\d{4})-(\d{2})-(\d{2})$/,$c=/^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)$/,Ub=/^(\d{4})-W(\d\d)$/,ad=/^(\d{4})-(\d\d)$/,bd=/^(\d\d):(\d\d)$/,ef=/(\b|^)default(\b|$)/,cd={text:bb,date:cb("date",Zc,zb(Zc,["yyyy","MM","dd"]),"yyyy-MM-dd"),"datetime-local":cb("datetimelocal",$c,zb($c,["yyyy","MM","dd","HH","mm"]),"yyyy-MM-ddTHH:mm"),time:cb("time",bd,zb(bd,["HH","mm"]),"HH:mm"),week:cb("week",Ub,function(a){if(ra(a))return a;if(v(a)){Ub.lastIndex=0;var c=Ub.exec(a);
if(c){a=+c[1];var d=+c[2],c=Vc(a),d=7*(d-1);return new Date(a,0,c.getDate()+d)}}return NaN},"yyyy-Www"),month:cb("month",ad,zb(ad,["yyyy","MM"]),"yyyy-MM"),number:function(a,c,d,e,f,g){bb(a,c,d,e,f,g);e.$parsers.push(function(a){var c=e.$isEmpty(a);if(c||df.test(a))return e.$setValidity("number",!0),""===a?null:c?a:parseFloat(a);e.$setValidity("number",!1);return r});Xe(e,"number",c);e.$formatters.push(function(a){return e.$isEmpty(a)?"":""+a});d.min&&(a=function(a){var c=parseFloat(d.min);return qa(e,
"min",e.$isEmpty(a)||a>=c,a)},e.$parsers.push(a),e.$formatters.push(a));d.max&&(a=function(a){var c=parseFloat(d.max);return qa(e,"max",e.$isEmpty(a)||a<=c,a)},e.$parsers.push(a),e.$formatters.push(a));e.$formatters.push(function(a){return qa(e,"number",e.$isEmpty(a)||Ab(a),a)})},url:function(a,c,d,e,f,g){bb(a,c,d,e,f,g);a=function(a){return qa(e,"url",e.$isEmpty(a)||bf.test(a),a)};e.$formatters.push(a);e.$parsers.push(a)},email:function(a,c,d,e,f,g){bb(a,c,d,e,f,g);a=function(a){return qa(e,"email",
e.$isEmpty(a)||cf.test(a),a)};e.$formatters.push(a);e.$parsers.push(a)},radio:function(a,c,d,e){E(d.name)&&c.attr("name",eb());var f=function(f){c[0].checked&&a.$apply(function(){e.$setViewValue(d.value,f&&f.type)})};if(e.$options&&e.$options.updateOn)c.on(e.$options.updateOn,f);if(!e.$options||e.$options.updateOnDefault)c.on("click",f);e.$render=function(){c[0].checked=d.value==e.$viewValue};d.$observe("value",e.$render)},checkbox:function(a,c,d,e){var f=d.ngTrueValue,g=d.ngFalseValue;v(f)||(f=!0);
v(g)||(g=!1);d=function(d){a.$apply(function(){e.$setViewValue(c[0].checked,d&&d.type)})};if(e.$options&&e.$options.updateOn)c.on(e.$options.updateOn,d);if(!e.$options||e.$options.updateOnDefault)c.on("click",d);e.$render=function(){c[0].checked=e.$viewValue};e.$isEmpty=function(a){return a!==f};e.$formatters.push(function(a){return a===f});e.$parsers.push(function(a){return a?f:g})},hidden:w,button:w,submit:w,reset:w,file:w},ic=["$browser","$sniffer","$filter",function(a,c,d){return{restrict:"E",
require:["?ngModel"],link:function(e,f,g,h){h[0]&&(cd[I(g.type)]||cd.text)(e,f,g,h[0],c,a,d)}}}],wb="ng-valid",vb="ng-invalid",Na="ng-pristine",yb="ng-dirty",ff=["$scope","$exceptionHandler","$attrs","$element","$parse","$animate","$timeout",function(a,c,d,e,f,g,h){function l(a,c){c=c?"-"+ib(c,"-"):"";g.removeClass(e,(a?vb:wb)+c);g.addClass(e,(a?wb:vb)+c)}this.$modelValue=this.$viewValue=Number.NaN;this.$parsers=[];this.$formatters=[];this.$viewChangeListeners=[];this.$pristine=!0;this.$dirty=!1;
this.$valid=!0;this.$invalid=!1;this.$name=d.name;var k=f(d.ngModel),m=k.assign,p=null,n=this;if(!m)throw B("ngModel")("nonassign",d.ngModel,ha(e));this.$render=w;this.$isEmpty=function(a){return E(a)||""===a||null===a||a!==a};var s=e.inheritedData("$formController")||xb,t=0,r=this.$error={};e.addClass(Na);l(!0);this.$setValidity=function(a,c){r[a]!==!c&&(c?(r[a]&&t--,t||(l(!0),n.$valid=!0,n.$invalid=!1)):(l(!1),n.$invalid=!0,n.$valid=!1,t++),r[a]=!c,l(c,a),s.$setValidity(a,c,n))};this.$setPristine=
function(){n.$dirty=!1;n.$pristine=!0;g.removeClass(e,yb);g.addClass(e,Na)};this.$cancelUpdate=function(){h.cancel(p);n.$render()};this.$$realSetViewValue=function(d){n.$viewValue=d;n.$pristine&&(n.$dirty=!0,n.$pristine=!1,g.removeClass(e,Na),g.addClass(e,yb),s.$setDirty());q(n.$parsers,function(a){d=a(d)});n.$modelValue!==d&&(n.$modelValue=d,m(a,d),q(n.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}}))};this.$setViewValue=function(a,c){var d=n.$options&&(T(n.$options.debounce)?n.$options.debounce[c]||
n.$options.debounce["default"]||0:n.$options.debounce)||0;h.cancel(p);d?p=h(function(){n.$$realSetViewValue(a)},d):n.$$realSetViewValue(a)};a.$watch(function(){var c=k(a);if(n.$modelValue!==c){var d=n.$formatters,e=d.length;for(n.$modelValue=c;e--;)c=d[e](c);n.$viewValue!==c&&(n.$viewValue=c,n.$render())}return c})}],Sd=function(){return{require:["ngModel","^?form","^?ngModelOptions"],controller:ff,link:function(a,c,d,e){var f=e[0],g=e[1]||xb;g.$addControl(f);e[2]&&(f.$options=e[2].$options);a.$on("$destroy",
function(){g.$removeControl(f)})}}},Ud=aa({require:"ngModel",link:function(a,c,d,e){e.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),jc=function(){return{require:"?ngModel",link:function(a,c,d,e){if(e){d.required=!0;var f=function(a){if(d.required&&e.$isEmpty(a))e.$setValidity("required",!1);else return e.$setValidity("required",!0),a};e.$formatters.push(f);e.$parsers.unshift(f);d.$observe("required",function(){f(e.$viewValue)})}}}},Td=function(){return{require:"ngModel",link:function(a,
...
c,d){m=a;p=d};l.addOption=function(c,d){Ba(c,'"option value"');k[c]=!0;m.$viewValue==c&&(a.val(c),p.parent()&&p.remove());"selected"===d.attr("selected")&&(d[0].selected=!0)};l.removeOption=function(a){this.hasOption(a)&&(delete k[a],m.$viewValue==a&&this.renderUnknownOption(a))};l.renderUnknownOption=function(c){c="? "+Ja(c)+" ?";p.val(c);a.prepend(p);a.val(c);p.prop("selected",!0)};l.hasOption=function(a){return k.hasOwnProperty(a)};c.$on("$destroy",function(){l.renderUnknownOption=w})}],link:function(e,
...
function(){a.$apply(function(){var a=[];q(c.find("option"),function(c){c.selected&&a.push(c.value)});d.$setViewValue(a)})})}function p(e,f,g){function h(){var a={"":[]},c=[""],d,k,r,t,z;t=g.$modelValue;z=y(e)||[];var D=n?Vb(z):z,H,J,C;J={};r=!1;var E,I;if(s)if(w&&L(t))for(r=new Xa([]),C=0;C<t.length;C++)J[m]=t[C],r.put(w(e,J),t[C]);else r=new Xa(t);for(C=0;H=D.length,C<H;C++){k=C;if(n){k=D[C];if("$"===k.charAt(0))continue;J[n]=k}J[m]=z[k];d=p(e,J)||"";(k=a[d])||(k=a[d]=[],c.push(d));s?d=A(r.remove(w?
